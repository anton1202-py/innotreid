...
def change_price_info():
    ...
    postgreSQL_select_Query = """SELECT DISTINCT t1.seller_article, t2.price AS today_price, t2.spp as today_spp,
        t1.price AS yesterday_price, t1.spp AS yesterday_spp
