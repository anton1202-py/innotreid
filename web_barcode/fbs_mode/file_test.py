...
class WildberriesFbsMode():
    ...
    def article_data_for_tickets(self):
        ...
        # Список с ID сборочных заданий
        orders_id_list = [1353059668, 1353749670, 1354148257]
        # Список с артикулами_продавца сборочных заданий
        order_articles_list = ['V354', 'V325', 'V385']
        # Словарь с данными {id_задания: артикул_продавца}
        self.article_id_dict = {1353059668: 'V354',
                                1353749670: 'V325', 1354148257: 'V385'}
        ...
        self.data_article_info_dict = {'V354': ['Ночник "Чужой"', 2022522462799], 'V325': [
            'Ночник "Джерри"', 2022522462669], 'V385': ['Ночник "Переходи на темную сторону"', 2022522461853]}
        ...
        self.amount_articles = {'V354': 1, 'V325': 1, 'V385': 1}
        # for order in orders_data:
...
#
    ...
    def create_selection_list(self):
        ...
        with open(path_file, 'rb') as f:
            dbx_db.files_upload(
                f.read(), f'{self.dropbox_current_assembling_folder}/{name_for_file}.xlsx')
        # except Exception as e:
        #    # обработка ошибки и отправка сообщения через бота
        #    message_text = error_message(
